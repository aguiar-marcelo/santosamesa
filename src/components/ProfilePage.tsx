                ...
                <div className="profile-page-content">
                        ...
                        <div>
                            ...
                            >
                                {restaurantsFavorites.map((r, index) => (
                                    ...
                                    >
                                        <Link href={`/local-info/${r.restaurant.id}`} className="local-restaurant-image-link">
                                            <img
                                        ...
                                        <div className="space-between">
                                            ...
                                            >
                                                <Link href={`/local-info/${r.restaurant.id}`} className="local-restaurant-name-link">
                                                    {r.restaurant.name}
                                                </Link>
                                            </b>
                                            <button
                    ...
                    <div className="grid grid-cols-[auto_1fr_auto] gap-[1%] items-center">
                        <h2 className="my-ratings-header">
                            {isOwnProfile
                                ? "Minhas avaliações"
                                : `Avaliações de ${profileUser?.exibitionName || profileUser?.userName
                                }`}
                        </h2>
