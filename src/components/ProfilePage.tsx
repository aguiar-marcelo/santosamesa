                ...
                <div className="profile-page-content">
                        ...
                        <div>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "15px", marginBottom: "10px" }}>
                                {Array(4).fill(null).map((_, index) => (
                                    <div key={index} className="bg-white rounded-md shadow-md p-4" style={{ minWidth: '0', overflow: 'hidden' }}>
                                        <img alt='Imagem do restaurante' className="local-restaurant-image" />
                                        <div className='space-between'>
                                            <b className="local-restaurant-name" style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>Nome</b>
                                            <Bookmark />
                                        </div>
                                        <p className="local-restaurant-category" style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>Categoria</p>
                                        <div className="local-restaurant-rating">
                                            <img className="local-restaurant-star" src="/img/estrela-preenchida.png" alt="Estrela" style={{ width: '16px', height: '16px', marginRight: '2px' }} />
                                        </div>
                                        <p className="local-restaurant-description" style={{ fontSize: '0.8rem', color: '#666', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>Descrição</p>
                                        <button className="local-restaurant-button bg-primary text-white rounded-md py-2 px-4 mt-2" style={{ fontSize: '0.8rem' }}>Saiba mais</button>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-[auto_1fr_auto] gap-[1%] items-center">
                        <h2 className="my-ratings-header">
                            {isOwnProfile ? 'Minhas avaliações' : `Avaliações de ${profileUser?.exibitionName || profileUser?.userName}`}
                        </h2>
