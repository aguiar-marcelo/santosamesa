...
const Cadastro = () => {
  ...
  return (
    ...
    >
      <div className="cadastro-form-wrapper background">
          ...
          {etapa === 1 ? (
            <div className="cadastro-form-stage-1">
              ...
              <div className="btn-container">
                ...
                <button
                  type="button"
                  className="cadastro-next-button bg-primary"
            ...
            <div className="cadastro-form-stage-2">
                ...
                <div className="profile-picture-container">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`cadastro-file-input shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline ${fileError ? 'cadastro-input-error' : ''}`}
              ...
              <div className="cadastro-buttons-stage-2">
                <button
                  type="button"
                  className="cadastro-submit-button bg-primary"
                  disabled={loading}
                  onClick={register}
                >
                  {loading ? (
