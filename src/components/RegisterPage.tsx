                ...
                <div className="w-full max-w-lg bg-white bg-opacity-80 p-8 rounded-lg shadow-lg">
                    {etapa === 1 ? (
                        <div className="flex flex-col items-center">
                            ...
                            <input type="email" placeholder="Digite seu e-mail" className="w-4/5 p-3 border-4 border-[#E5DCDC] rounded-lg mb-4" />
                            <p className="w-4/5 mb-2 text-left">Crie sua senha *</p>
                            <input type="password" placeholder="Digite a senha que deseja criar" className="w-4/5 p-3 border-4 border-[#E5DCDC] rounded-lg mb-4" />
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <input type="text" placeholder="Digite o nome a ser apresentado" className="w-4/5 p-3 border-4 border-[#E5DCDC] rounded-lg mb-4" />
